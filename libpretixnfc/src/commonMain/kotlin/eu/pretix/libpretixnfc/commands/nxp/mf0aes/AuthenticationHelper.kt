...
import eu.pretix.libpretixnfc.cryptography.computeAesCmac
import eu.pretix.libpretixnfc.cryptography.decryptAesCbc
import eu.pretix.libpretixnfc.cryptography.encryptAesCbc
import eu.pretix.libpretixnfc.cryptography.secureRandomBytes
...
private val defaultAesEncrypt = { secret: ByteArray ->
    { plaintext: ByteArray -> encryptAesCbc(secret, plaintext) }
}
private val defaultAesDecrypt = { secret: ByteArray ->
    { ciphertext: ByteArray -> decryptAesCbc(secret, ciphertext) }
}
...
fun aesCmac(secret: ByteArray, plaintext: ByteArray): ByteArray {
    return computeAesCmac(secret, plaintext)
}
